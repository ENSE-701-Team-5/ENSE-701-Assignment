...
export default function Terms() {
  return (
    <div className={"terms"}>
      <h2>Terms of Use (Placeholder - http://opensource-template.wikidot.com/legal:terms-of-use)</h2>
      <h3>Legal Notices</h3>
      <p>
        We, SEER the Operators of this Website, provide it as a public service to our
        users. Please carefully review the following basic rules that govern
        your use of the Website. Please note that your use of the Website
        constitutes your unconditional agreement to follow and be bound by these
        Terms and Conditions of Use. If you (the "User") do not agree to them,
        do not use the Website, provide any materials to the Website or download
        any materials from them. SEER reserve the right to update or
        modify these Terms and Conditions at any time without prior notice to
        User. Your use of the Website following any such change constitutes your
        unconditional agreement to follow and be bound by these Terms and
        Conditions as changed. For this reason, we encourage you to review these
        Terms and Conditions of Use whenever you use the Website. These Terms
        and Conditions of Use apply to the use of the Website and do not extend
        to any linked third party sites. These Terms and Conditions and our
        Privacy Policy, which are hereby incorporated by reference, contain the
        entire agreement (the “Agreement”) between you and SEER with
        respect to the Website. Any rights not expressly granted herein are
        reserved.
      </p>
      ...
      <p>
        ...
        information to third-party parties for marketing purposes. SEER
        ...
        Conditions of Use, and SEER reserve the right to terminate or
      ...
      <p>
        SEER note that unauthorized use of Users' personal information
        ...
        SEER reserve the right to report the abuse of Users' personal
        information to the appropriate law enforcement and government
        authorities, and SEER will fully cooperate with any authorities
        investigating violations of these laws.
      </p>
      <h3>User Submissions</h3>
      <p>
        SEER do not want to receive confidential or proprietary
      ...
      <p>
        ...
        to anyone who wishes to use them, including SEER.
      </p>
      <p>
      ...
      <p>
        SEER may, but are not obligated to, monitor or review any areas
        ...
        libel, privacy, obscenity, or otherwise. SEER may edit or
      ...
      <p>
        ...
        the Website using your account or User ID. You grant SEER and
        ...
        provision of services to you. SEER cannot and do not assume any
      ...
      <p>
        You agree to defend, indemnify and hold harmless SEER, agents,
      ...
      <p>
        ...
        SEER reserve the right to terminate or suspend your access to
        ...
        entity; or (iii) where SEER have reason to believe that you are
      ...
      <p>
        ...
        PARTICULAR PURPOSE, OR NON-INFRINGEMENTOF INTELLECTUAL PROPERTY. THE
      ...
      <h3>General</h3>
      <p>
        The Website is hosted in the United States. SEER make no claims
        ...
        the scope or extent of such section. The failure of SEER to act
        with respect to a breach of this Agreement by you or others does not
        constitute a waiver and shall not limit SEER' rights with
      ...
      <p>
        ...
        the companies or products referenced therein, and SEER reserve
        ...
        offensive, SEER cannot be held responsible for the accuracy,
